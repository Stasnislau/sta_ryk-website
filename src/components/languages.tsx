...
const LanguageCard = ({ language, index }:
    ...
    return (
        <motion.div variants={fadeIn("up", "string", index * 0.5, 0.75)} custom={index}>
            <div className="flex flex-col items-center justify-center text-center bg-tertiary rounded-[20px] shadow-card p-4">
                ...
                <div className="relative w-32 h-32 p-4">
                    <div className="relative w-full h-full rounded-full bg-tertiary opacity-100">
                        <div className="absolute top-0 left-0 w-full h-full border-[10px] border-[#AAA6c3] rounded-full bg-tertiary"></div>
